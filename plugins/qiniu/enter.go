...
// UploadAttachment 上传附件 (data	hash.jpg	blog)
func UploadAttachment(data []byte, attachment string, prefix string) (filePath string, err error) {
	...
	// 获取当前时间
	key := fmt.Sprintf("%s/%s", prefix, attachment)
